...
export CUDA_VISIBLE_DEVICES="0,1,2"  # 在 多卡的情况下指定
python -m torch.distributed.run --nproc_per_node=3 --master_port=2734 tools/fine_tune.py projects/configs/FreeAD/FreeAD_base_map_fine_tune.py --launcher pytorch --deterministic --work-dir path/to/save/outputs
