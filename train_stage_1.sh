...
python -m torch.distributed.run --nproc_per_node=2 --master_port=2734 tools/train.py projects/configs/FreeAD/FreeAD_base_stage_1.py --launcher pytorch --deterministic --work-dir path/to/save/outputs/FreeWorld_s1

# train with 1 card
# python tools/train.py projects/configs/FreeAD/FreeAD_base_stage_1.py --deterministic --work-dir path/to/save/outputs/FreeAskWorld_s1e3s2e1_FreeWorld_s1
