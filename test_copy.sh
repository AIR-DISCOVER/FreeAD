...
CUDA_VISIBLE_DEVICES=1 python tools/test.py projects/configs/FreeAD/FreeAskWorld.py ckpts/VAD_FreeeAskWorlds1e3s2e1_FreeWorld_s1e1.pth --launcher none --eval bbox --tmpdir tmp
