...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        ...
        #     'img_backbone': dict(lr_mult=0.1),
        #     'pts_bbox_head.ego_agent_decoder':dict(lr_mult=0.1),
        #     'pts_bbox_head.ego_map_decoder':dict(lr_mult=0.1),
        #     'pts_bbox_head.motion_decoder':dict(lr_mult=0),
        #     'pts_bbox_head.bbox_coder':dict(lr_mult=0.1),
        #     'pts_bbox_head.map_bbox_coder':dict(lr_mult=0.1),
        #     'pts_bbox_head.positional_encoding':dict(lr_mult=0.1),
        # }),
        custom_keys={
            'img_backbone': dict(lr_mult=0.1),
        }),
...
load_from = "/home/tsinghuaair/pengyh/FreeAD/my_project/FreeAD/ckpts/resnet50-19c8e357.pth"