...
python -m torch.distributed.run --nproc_per_node=3 --master_port=2734 tools/train.py projects/configs/FreeAD/FreeAD_base_stage_1.py --launcher pytorch --deterministic --work-dir path/to/save/outputs
