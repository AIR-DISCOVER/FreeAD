...
def main():
    ...
    #     # 遍历模型的所有模块并将名称和类型写入文件
    #     for name, module in model.named_modules():
    #         f.write(f"Layer name: {name}, Layer type: {module.__class__.__name__}\n")
        
    # 冻结模型某些模块，来进行fine-tuning
    # for param in model.parameters():
    #     param.requires_grad=False
        
    # 解冻与地图解码器相关的参数
    # for name, param in model.pts_bbox_head.transformer.map_decoder.named_parameters():
    #     param.requires_grad = True

    # 解冻与自车运动解码器相关的参数
    # for name, param in model.pts_bbox_head.motion_decoder.named_parameters():
    #     param.requires_grad = True
