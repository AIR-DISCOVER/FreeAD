...
#         self.X_BOUND = [-25.0, 25.0, 0.25]  # Forward
#         self.Y_BOUND = [-25.0, 25.0, 0.25]  # Sides
#         self.Z_BOUND = [-5.0, 5.0, 10.0]  # Height
...
#         # Correct conversion: Flip the y-coordinate to map from LiDAR to trajectory coordinates
#         trajs_ = copy.deepcopy(trajs)
#         trajs_[:,:,[0,1]] = trajs_[:,:,[0,1]]  # No change to x
#         trajs_[:,:,1] = -trajs_[:,:,1]  # Flip the y-coordinate
